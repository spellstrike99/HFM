...
country = {
	...
	UNCIV_TECH_SPREAD_MAX = 0.50, --Max techs an unciv will get on westernizing
	UNCIV_TECH_SPREAD_MIN = 0.25, --Minimum techs an unciv will get on westernizing
...
diplomacy = {
	...
	CB_DETECTION_CHANCE_BASE = 8, -- chance out of 1000 every day
